...
const { UNISWAP_FACTORY, UNISWAP_ROUTER, WETH_KOVAN } = process.env;
...
module.exports = async function (deployer, network, accounts) {
  ...
  //     uniswapOracle = await deployer.deploy(
  //       PriceOracle,
  //       uniswapPair,
  ...
  //     await feeApproverInstance.initialize(
  //       uniswapPair,
